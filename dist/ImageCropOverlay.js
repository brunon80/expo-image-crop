...
class ImageCropOverlay extends React.Component {
    ...
    calcRect() {
        ...
        const calculator = new CropRectCalculator(new Rect(initialTop, initialLeft, initialWidth, initialHeight), (ratio && ratio.width && ratio.height) ? ratio.width / ratio.height : undefined, this.props.minWidth, this.props.minHeight, new Rect(this.props.imageLayout.y, this.props.imageLayout.x, this.props.imageLayout.width, this.props.imageLayout.height));
        if (draggingTL) {
            calculator.fixRight();
